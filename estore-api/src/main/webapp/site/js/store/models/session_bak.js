...
APP.Session = Backbone.Model.extend({	url : function() {
	...
	initialize : function(model, options) {
		...
		if (!this.options.persist && typeof sessionStorage != "undefined"
				&& sessionStorage !== null) {
			// choose localStorage
			this.store = this.sessionStorage;
		} else if (this.options.persist && typeof localStorage != "undefined"
				&& localStorage !== null) {
			// choose localStorage
