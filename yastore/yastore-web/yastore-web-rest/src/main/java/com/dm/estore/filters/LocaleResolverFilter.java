...
@WebFilter(value = "/*", asyncSupported = true,
	initParams = {
		@WebInitParam(name = "description", value = "Locale resolving filter")
	},
	dispatcherTypes = {
...
public class LocaleResolverFilter implements Filter {
	...
	@Override
	public void destroy() {
		LOG.debug("Destroy locale resolver filter");
	}
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		// LOG.debug("... process locale resolver filter");
		chain.doFilter(request, response);
	}

	@Override
	public void init(FilterConfig arg0) throws ServletException {
		LOG.debug("Initialize locale resolver filter");
	}
